##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.5.0-RC5] date: [Thu Feb 05 18:57:29 CST 2026] 
##########################################################################################################################
...
Robot/daemon/daemon.c \
Robot/Devices/BMI088/BMI088driver.c \
Robot/Devices/BMI088/BMI088Middleware.c \
Robot/Devices/Hipnuc/hipnuc_dec.c \
Robot/Devices/Motor/djimotor.c \
Robot/Devices/Motor/dmmotor.c \
Robot/Lib/user_lib.c \
Robot/Remote/remote_control.c \
...
-IBsp \
-IRobot/Algorithm/EKF \
-IRobot/Algorithm/kalman \
-IRobot/Algorithm/mahony \
-IRobot/Controller \
-IRobot/daemon \
-IRobot/Devices/BMI088 \
-IRobot/Devices/Hipnuc \
-IRobot/Devices/Motor \
-IRobot/Devices \
-IRobot/Lib \
-IRobot/Remote \
-IRobot/RoboTask/ins \
-IRobot/RoboTask/chassis \
-IRobot/RoboTask/observe \
-IRobot/RoboTask/emulator \
-IRobot/RoboTask/remote \
-IRobot/RoboTask \
...
LDFLAGS = $(MCU) -specs=nano.specs -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -u _printf_float -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections,--print-memory-usage
