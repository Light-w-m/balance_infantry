...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|led_5v_Pin|ACC_CS_Pin|GYRO_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : PC13 led_5v_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_13|led_5v_Pin;
